...
export const setupPresetButtons = (mqtt: IMQTTConnection, controller: RevCBController) => {
  ...
  // Program Memory 1-4 buttons live in setupMemoryTracking.ts instead of here - saving
  // a slot needs to also capture/persist the bed's current position, not just write a
  // command.
};
